...
//
//     final eShopeModel = eShopeModelFromJson(jsonString);

import 'dart:convert';

EShopeModel eShopeModelFromJson(String str) => EShopeModel.fromJson(json.decode(str));

String eShopeModelToJson(EShopeModel data) => json.encode(data.toJson());
...
class EShopeModel {
  ...
  factory EShopeModel.fromJson(Map<String, dynamic> json) => EShopeModel(
